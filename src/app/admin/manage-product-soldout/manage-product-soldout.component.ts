...
@Component({
  selector: 'app-manage-product-soldout',
  standalone: true,
  imports: [RouterLink, ReactiveFormsModule, CommonModule, FormsModule],
  templateUrl: './manage-product-soldout.component.html',
  styleUrl: './manage-product-soldout.component.css'
})
export class ManageProductSoldoutComponent implements OnInit {
  products: any[] = [];
  ...
  loadProducts(): void {
    this.adminService
      .getManageAllSouldOutProduct(this.keyword, this.PageSize, this.PageNumber)
      .subscribe({
        next: (response) => {
  ...
  onDelete(productId: number): void {
    if (confirm('Are you sure you want to delete this product?')) {
      this.adminService.BackOnSaleManageProduct(productId).subscribe({
        next: () => {
  ...
  openSoldOut() {
    this.router.navigateByUrl('/admin/manageProduct')
  }
